...
<?php
		...
		if ($pego_page_post_type == 'fitrows') {
			$wrap_class = 'pego-isotope-wrapper-fitrows';
		}
		...
		?>
			<div class="page-title-wrapper"<?php echo $bg_css; ?>>
				<div class="page-title">
					<h1><?php if ($pego_page_title_page_title_text != '') { echo esc_html($pego_page_title_page_title_text); } else { the_title(); } ?></h1>
			...
			?>
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>	
						...
						<div class="vc_row wpb_row vc_row-fluid">
							<div class="<?php echo esc_attr($main_class); ?> wpb_column vc_column_container expand_container">
