 ...
 */
function orbisius_ctc_xavier_child_theme_enqueue_styles() {
    $parent_style = 'orbisius_ctc_xavier_parent_style';
    $parent_base_dir = 'xavier';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ctc_xavier_child_theme_enqueue_styles' );

/* convert_date is used by WP-import only */
